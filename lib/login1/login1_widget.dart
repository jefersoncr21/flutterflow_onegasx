  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      final user = await authManager.signInWithEmail(
        context,
        _model.textFieldmailController.text,
        _model.textFieldcomtraseController.text,
      );
      if (user == null) {
        return;
      }

      context.goNamedAuth('selectDestinationPage', context.mounted);
    });

    _model.textFieldmailController ??=
        TextEditingController(text: widget.email);
    _model.textFieldcomtraseController ??=
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 0.0),
                      child: TextFormField(
                        controller: _model.textFieldcomtraseController,
                        autofocus: true,
                        obscureText: !_model.textFieldcomtraseVisibility,
                        decoration: InputDecoration(
                          labelText: 'Label here...',
                          labelStyle: FlutterFlowTheme.of(context).labelMedium,
                          hintStyle: FlutterFlowTheme.of(context).labelMedium,
                          ...
                          suffixIcon: InkWell(
                            onTap: () => setState(
                              () => _model.textFieldcomtraseVisibility =
                                  !_model.textFieldcomtraseVisibility,
                            ),
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium,
                        validator: _model.textFieldcomtraseControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ],
